    ...
    <section class="container-fluid">
        <div class="row content">
            <div class="col-md-8 offset-md-2 pl-0 pr-0">
                ...
                <form action="{{ route('batch_update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('batch_name') is-invalid @enderror" name="batch_name" value="{{ $batch->batch_name }}" id="batch_name" placeholder="Enter Batch Capacity" required>
                                            @error('batch_name')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('student_capacity') is-invalid @enderror" name="student_capacity" value="{{ $batch->student_capacity }}" id="batch_name" placeholder="Enter Batch Name" required>
