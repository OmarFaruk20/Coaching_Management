    ...
    <div class="row content info">
        <div class="col-12 pl-0 pr-0">
            <div class="form-group">
                <div class="col-sm-12">
                    <h4 class="text-center font-weight-bold font-italic mt-3">Edit Users Info</h4>
                </div>
            </div>

            <form method="POST" action="{{ route('update_user_info')}}" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                @csrf
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="email" type="email" class="col-sm-9 form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" placeholder="Email Address" required autocomplete="email">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
